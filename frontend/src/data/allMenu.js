export const menu = [
    {
        ...
        icon: 'campus',
        description:
            'A unique, exclusive space for college students on SocioReact.',
    },
    {
        name: 'Events',
        icon: 'events',
    ...
    },
    {
        name: 'Pages',
        icon: 'pages',
        description: 'Discover and connect with businesses on SocioReact.',
    },
    {
        name: 'Gaming Video',
        icon: 'gaming',
    ...
    },
    {
        ...
        icon: 'recent',
        description: 'See all the ads you interacted with on SocioReact.',
    },
    {
        name: 'Memories',
        icon: 'memories',
        description: 'Browse your old photos, videos and posts on SocioReact.',
    },
    {
        name: 'Saved',
        icon: 'saved',
