    ...
    return (
        <header>
            ...
            <div className="header_middle">
                ...
                <Link to="/Youtube" className="middle_icon hover1">
                    <Watch color={color} />
                </Link>
                <Link to="/weather" className="middle_icon hover1">
                    <img src="http://localhost:3000/left/weather.png" />
                </Link>
                {/* <Link to="/weather" className="middle_icon hover1 ">
                    <Gaming color={color} />
                </Link> */}
